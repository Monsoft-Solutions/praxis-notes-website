          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[80vh]">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <button
                    className="h-12 px-8 bg-purple-400 hover:bg-purple-500 text-white font-quicksand font-semibold transition-all hover:shadow-md"
                ...
                <Link href="#how-it-works">
                  <button
                    className="h-12 px-8 border-2 border-indigo-300 text-indigo-600 hover:bg-indigo-50 font-quicksand font-semibold transition-all hover:shadow-md"
